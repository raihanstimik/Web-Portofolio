    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="{{ route('storeUser') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="role" id="role" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Enter 1 or 2">
            </div>
