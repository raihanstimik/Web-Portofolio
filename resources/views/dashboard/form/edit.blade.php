...
@section('home')
    <form class="border border-gray-900/10 rounded-lg shadow-lg p-10" action="{{ route('form.update',$identitas->id) }}" method="POST">
      @csrf
      @method('PUT')
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <div class="mb-5">
                            ...
                            <input type="text" id="nama" name="nama" placeholder="Nama" value="{{ $identitas->nama }}"
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <select id="provinsi" name="provinsi" autocomplete="provinsi" value="{{ $identitas->provinsi }}"
                    ...
                    <div class="sm:col-span-3">
                        <form class="max-w-sm mx-auto">
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email
                                Aktif</label>
                            <input type="email" id="email" name="email" aria-describedby="helper-text-explanation" value="{{ $identitas->email }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div class="sm:col-span-3">
                        <div class="">
                            ...
                            <textarea id="isi" rows="8" cols="50" name="isi" 
                                ...
                                placeholder="Saya seorang Kapten kapal laud dan memiliki minat bakat pada ternak ikan lele....">{{ $identitas->isi }}</textarea>
                        </div>
                    </div>
                ...
                <div class="sm:col-span-3 mt-5">
                    <div class="mb-5">
                        <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Posisi
                            :</label>
                        <input type="text" id="base-input" name="posisi" placeholder="administrasi" value="{{ $identitas->posisi }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3 mt-5">
                    <div class="mb-5">
                        <label for="perusahaan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Perusahaan :</label>
                        <input type="text" id="perusahaan" name="perusahaan" placeholder="PT.push mytic glory" value="{{ $identitas->perusahaan }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                ...
                <div class="sm:col-span-3">
                    <div class="mb-5">
                        <label for="tanggal_mulai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                            mulai :</label>
                        <input type="date" id="tgl_mulai" name="tgl_mulai" value="{{ $identitas->tgl_mulai }}"
                ...
                <div class="sm:col-span-3">
                    <div class="mb-5">
                        <label for="tgl_akhir" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                            akhir:</label>
                        <input type="date" id="tgl_akhir" name="tgl_akhir" value="{{ $identitas->tgl_akhir }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
                    ...
                    <div class="mb-5">
                        <div class="">
                            ...
                            <textarea id="jobdesk" rows="8" name="jobdesk" 
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="*Melakukan analisa kredit terperinci...">{{ $identitas->jobdesk }}</textarea>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="border-b border-gray-900/10 pb-12 mt-7">
                        ...
                        <div class="sm:col-span-3 mt-5">
                            <div class="mb-5">
                                <label for="sekolah"
                                    ...
                                    :</label>
                                <input type="text" id="sekolah" name="sekolah" value="{{ $identitas->sekolah }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            <div class="mb-5">
                                ...
                                <input type="text" id="jurusan" name="jurusan"value="{{ $identitas->jurusan }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                            {{-- tanggal masuk --}}
                            <div class="sm:col-span-3">
                                <div class="mb-5">
                                    <label for="tgl_mulai2"
                                        ...
                                        :</label>
                                    <input type="date" id="tgl_mulai2" name="tgl_mulai2" value="{{ $identitas->tgl_mulai2 }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                            </div>
                            {{-- tanggal lulus --}}
                            <div class="sm:col-span-3">
                                <div class="mb-5">
                                    <label for="tgl_akhir2"
                                        ...
                                        :</label>
                                    <input type="date" id="tgl_akhir2" name="tgl_akhir2" value="{{ $identitas->tgl_akhir2 }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                            </div>
                            {{-- nilai --}}
                            <div class="sm:col-span-3">
                                <div class="mb-5">
                                    ...
                                    <input type="text" id="ipk" name="ipk" value="{{ $identitas->ipk }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                            </div>
                            {{-- keterangan textarea --}}
                            <div class="sm:col-span-3">
                                <div class="mb-5">
                                    ...
                                    <textarea id="isi2" rows="8" name="isi2" 
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="*opsional">{{ $identitas->isi2 }}</textarea>
                                </div>
                            </div>
                            <hr>
                            {{-- soft skill textarea --}}
                            <div class="sm:col-span-3">
                                <div class="mb-5">
                                    ...
                                    <textarea id="softskill" rows="8" name="softskill" 
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="*opsional">{{ $identitas->softskill }}</textarea>
                                </div>
                                {{-- hard skill textarea --}}
                                <div class="sm:col-span-3">
                                    <div class="mb-5">
                                        ...
                                        <textarea id="hardskill" rows="8" name="hardskill" value="{{ Session::get('hardskill') }}"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="*opsional">{{ $identitas->hardskill }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="sm:col-span-3">
                                    <div class="mb-5">
                                        ...
                                        <textarea id="bahasa" rows="8" name="bahasa" 
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="*opsional">{{ $identitas->bahasa }}</textarea>
                                    </div>
                                </div>
