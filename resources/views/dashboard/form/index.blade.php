...
<p>*riwayat akan di tampilkan jika form terisi</p>
    @foreach ($identitas as $item)
            ...
            <form onsubmit="return confirm('Yakin mau hapus data diri ini?')" action="{{ route('form.destroy', $item->id) }}" method="POST" class="me-2 mb-2">
@csrf
@method('DELETE')
